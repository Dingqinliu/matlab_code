...
p_v13L=1-sum(normcdf(zL*(4*kL1+1)/sqrt(n1))-normcdf(zL*(4*kL1-1)/sqrt(n1))) ...
    +sum(normcdf(zL*(4*kL2+3)/sqrt(n1))-normcdf(zL*(4*kL2+1)/sqrt(n1)));
kR1=floor(4*(-n1/zR+1)):floor(4*(n1/zR-1));
kR2=floor(4*(-n1/zR-3)):floor(4*(n1/zR-1));
p_v13R=1-sum(normcdf(zR*(4*kR1+1)/sqrt(n1))-normcdf(zR*(4*kR1-1)/sqrt(n1))) ...
    +sum(normcdf(zR*(4*kR2+3)/sqrt(n1))-normcdf(zR*(4*kR2+1)/sqrt(n1)));
